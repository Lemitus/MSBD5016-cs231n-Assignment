...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
            h, cache = rnn_forward(emb, h_in, Wx, Wh, b)
        else:
            h, cache = lstm_forward(emb, h_in, Wx, Wh, b)
        ...
        #backward
        dout, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dout, cache_s)
        if self.cell_type == 'rnn':
            dout, dh, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(dout, cache)
        else:
            dout, dh, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(dout, cache)
